...
function filter_className_select_att($connect)
{ 
    $output = '';  
    $sql = "SELECT DISTINCT classes.class_name FROM attendance  INNER JOIN classes ON attendance.class_id=classes.class_id"; 
    $result = mysqli_query($connect, $sql);  
    while($row = mysqli_fetch_array($result))  
    {  
...
<div class="table-wrapper-scroll-y my-custom-scrollbar" >
         ...
         <tr >
            ...
            <td><input  style="background-color: #9E9DB4"  class="form-control" ></td>
