...
echo $output;
      ...
      ?> 
        ...
        <tr  id="<?=$row['attendance_id'];?>">
            ...
            <button type="button" class="btn btn-success btn-sm update" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#edit_att" data-dismiss="modal"
